// Vue.component('blog',{
//   props:['title', 'img', 'alt', 'p', 'menu', 'blog_details', 'svg', 'p_quote', 'h2', 'p_under_quote', 'li_down', 'down_img', 'down_alt', 'p_down'],
//   template: `
//     <div>
//         <h1> {{title}} </h1>
//         <img :src="img" :alt="alt">
...
//             </menu>
//         </div>
//         <p class="blog-details">{{blog_details}}</p>
//         <div class="quote">
//             {{svg}}
//             <p> {{p_quote}} </p>
//         </div>
//         <h2>{{h2}}</h2>
//         <p class="blog-details">{{p_under_quote}}</p>
//         <ul>
//             <li
//             v-for="item in li_down"
//             > {{item}}
//             </li>
//         </ul>
//         <img :src="down_img" :alt="down_alt">
//         <p class="blog-details">{{p_down}}</p>
//     </div>
//   `,
// });

// Vue.component('change-two',{
//     template: "<h2> change two </h2>"
// });

// Vue.component('change-three',{
//     template: "<h2> change three </h2>"
// });
...
Vue.component('blog', {
    ...
    template: `
    <div class="blog" @click="showBlogDetails(blog.id)">
